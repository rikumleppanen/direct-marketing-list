...
public class ResultArea extends JFrame implements DocumentListener {
    ...
    public ResultArea(MarketingList list) {
        initComponents(list);
     ...
     *
     * @param list is the marketing list which content is printed on the
     * TextArea
     */
    private void initComponents(MarketingList list) {
        entry = new JTextField();
        textArea = new JTextArea(list.printString());
        status = new JLabel();
        jLabel1 = new JLabel();
